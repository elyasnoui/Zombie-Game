...
/*
void engine::perspective_camera::free_view(glm::vec3 pos, const timestep& timestep)
{
    auto [mouse_delta_x, mouse_delta_y] = input::mouse_position();
    ...
    m_position.x = glm::clamp(pos.x, -5.0f, 5.0f);
    m_position.y = glm::clamp(pos.y, 1.0f, 11.0f);
}
*/
